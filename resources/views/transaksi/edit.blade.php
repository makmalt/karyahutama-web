...
@section('title', 'POS Karya Hutama Oxygen - Edit Transaksi')
@section('content')
                            ...
                            <table class="table align-middle" id="barangTable">
                                ...
                                <tbody>
                                    @foreach ($transaksi->barangTransaksi as $bt)
                                        <tr>
                                            <td>
                                                <select name="barang_id[]" class="form-select barang-select select2"
                                                    required>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="harga_barang[]"
                                                        class="form-control harga-input" value="{{ $bt->harga_barang }}"
                                                        min="0" required>
                                                </div>
                                            </td>
                                            <td>
                                                <input type="number" name="quantity[]" class="form-control qty-input"
                                                    min="1" value="{{ $bt->quantity }}" required>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="total_harga[]"
                                                        class="form-control subtotal-input" value="{{ $bt->total_harga }}"
                                                        readonly>
                                                </div>
                                            </td>
