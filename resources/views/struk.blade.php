...
<head>
    ...
    <style>
        ...
        body {
            ...
            font-size: 3px;
            /* Font dasar sangat kecil sesuai permintaan */
            line-height: 1;
        ...
        .company-name {
            font-size: 6px;
            /* Font judul lebih besar agar tetap bisa dibaca */
            font-weight: bold;
            margin: 0 0 5px 0;
            padding: 0;
        }
...
<body onload="window.print()">
    ...
    <div style="margin: 5px 0;">
        ...
        <div>Tanggal: {{ $transaksi->tgl_transaksi->format('d/m/Y H:i') }}</div>
    </div>
    ...
    <div class="item-container">
        ...
        @foreach ($transaksi->barangTransaksi as $item)
            <div>
                <div class="item-name">{{ substr($item->barang->nama_barang, 0, 20) }}</div>
